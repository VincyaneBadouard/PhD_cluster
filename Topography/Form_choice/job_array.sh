...
#SBATCH --output=/lustre/badouardv/PhD_cluster/Topography/Form_choice/logsout/log_%a.out
#SBATCH --error=/lustre/badouardv/PhD_cluster/Topography/Form_choice/logserr/log_%a.err
#SBATCH --array=1-75
#SBATCH --time=1:00:00
