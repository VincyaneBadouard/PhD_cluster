#!/bin/bash
#SBATCH --job-name=Topo_Light_Onto_Aggrsp_sampling_array
#SBATCH --account=agap
...
singularity exec /lustre/badouardv/PhD_cluster/Singularity/cmdstanr.sif  Rscript Sampling_sp_array.R ${SLURM_ARRAY_TASK_ID} 2000
